...
**Note on multilingual coverage:** LaBSE and BGE-M3 are designed for Tamil, Hindi, Bengali, Urdu, Persian, and Arabic per their respective model documentation. Retrieval quality across these scripts has not yet been independently verified by partial-recall. Independent verification is planned for v0.6.0.
