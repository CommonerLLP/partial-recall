...
> [`../SCOPE.md`](../SCOPE.md). As of `v0.3.1`, PDF attachment fetch and
> reading-order PDF extraction are shipped, but EPUB attachment fetch remains a
> known gap tracked by `SCOPE.md`. Do not treat this file as an active scope
> document.
