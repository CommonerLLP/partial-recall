...
**Note on multilingual coverage:** LaBSE and BGE-M3 are designed for South Asian and Arabic scripts per their model documentation. Retrieval quality across Tamil, Hindi, Bengali, Urdu, Persian, and Arabic has not yet been independently verified by partial-recall. Independent verification is planned for v0.6.0.
